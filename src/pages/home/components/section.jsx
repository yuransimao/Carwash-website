      ...
      <div className='h-svh'>
        <div className='h-full flex flex-col items-center justify-center gap-6'>
          <div className='text-center flex flex-col gap-2'> 
            <h2 className='text-4xl font-bold'>Take care of your business</h2>
            <h4 className='text-lg capitalize text-light'>while we take care of 
            <span className="text-blue-600 font-medium"> your cars</span></h4>
            <p className='text-sm text-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
          ...
          <div className='relative w-2/3 h-[45%] overflow-hidden rounded-md after:absolute after:bg-zinc-800/50 after:w-full after:h-96 after:top-0 after:left-0 after:right-0 after:z-10'> 
          <Swipers>
            <SwiperSlide>
