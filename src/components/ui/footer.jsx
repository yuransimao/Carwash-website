  ...
  return (
    <React.Fragment>
        ...
        <footer className='bg-zinc-900'>
            ...
            <div className='flex items-center justify-center border-t-[1px] bg-black border-solid px-3 py-5'>
                <p className='text-sm text-center text-white '>Copyright  ©️ 2024 FLAMES Inc. All rights reserved ®️ Created by <span className='font-bold'>G</span></p>
